...
class Main extends PluginBase implements Listener
{
    ...
    public function onEnable()
    {
        ...
        $this->getLogger()->info(TextFormat::GREEN . "ArrowTP by xd_plugins_xd has been enabled!");
    ...
    {
        $this->getLogger()->info(TextFormat::GREEN . "ArrowTP by xd_plugins_xd has been disabled.");
    }
